...
const OrganizerEventList = ({ events }) => {
  ...
  /**
   * Checks if event deletion is allowed.
   * Admins can always delete. Organizers can only delete within 24 hours of creation.
   */
  const isDeletionAllowed = (event) => {
    if (isAdmin) return true;

    // Fallback for events without createdAt (legacy support)
  ...
  const handleDelete = (event) => {
    ...
    if (!isDeletionAllowed(event)) {
      alert(
        "Le délai de suppression de 24h est dépassé. Seul un administrateur peut supprimer cet événement."
      );
      return;
    }
          ...
          <div className="bg-white dark:bg-gray-800 rounded-[2.5rem] p-8 md:p-12 max-w-2xl w-full shadow-2xl border border-gray-100 dark:border-gray-700 animate-scale-up">
            <div className="text-center space-y-4 mb-10">
              <h3 className="text-3xl font-black text-gray-900 dark:text-white tracking-tight">
                Quel type d'événement <br />{" "}
                <span className="text-blue-600">souhaitez-vous créer ?</span>
              </h3>
              <p className="text-gray-500 dark:text-gray-400 font-medium">
                Choisissez la visibilité de votre événement. Vous pourrez la
                modifier plus tard.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              >
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 font-medium leading-relaxed">
                  Visible par tous les utilisateurs sur la plateforme et dans
              ...
              >
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 font-medium leading-relaxed">
                  Uniquement accessible via un lien direct. Non listé
                ...
                >
                  ...
                  <div className="flex-shrink-0 flex items-center gap-2 self-end md:self-center flex-wrap">
                    ...
                    <Button
                      ...
                      size="xs"
                      onClick={(e) =>
                        handleDownload(e, event._id || event.id, event.name)
                      }
                    ...
                    <Button
                      ...
                      title={
                        allowed
                          ? "Supprimer"
                          : "Suppression verrouillée (24h dépassées)"
                      }
                      className={
                        !allowed
