...
const AdvancedFilterPage = () => {
  ...
  const FilterSection = ({ title, items, category }) => (
    <div className="mb-8">
      <h3 className="text-lg font-bold mb-4 text-slate-500 dark:text-white flex items-center gap-2">
        {title}
      </h3>
            ...
            <button
              ...
              className={`flex items-center justify-between px-4 py-3 rounded-xl border transition-all duration-200 ${
                isSelected 
                  ...
                  : "bg-white border-gray-200 text-slate-500 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-300 hover:border-blue-300 dark:hover:border-blue-700"
              }`}
            >
    ...
    <MainLayout>
      <div className="max-w-5xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-8">
          ...
          <h1 className="text-2xl font-extrabold text-slate-500 dark:text-white">Filtres Avancés</h1>
          <button 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <input 
                ...
                className="w-full p-4 rounded-xl border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-slate-500 dark:text-white focus:ring-2 focus:ring-blue-500 outline-none transition-all"
              />
            </div>
            <div>
              <h3 className="text-lg font-bold mb-4 text-slate-500 dark:text-white flex items-center gap-2">
