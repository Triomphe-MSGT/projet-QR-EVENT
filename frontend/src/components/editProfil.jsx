...
const EditProfileForm = () => {
  ...
  return (
    <form
      ...
      // 1. Ajout de max-w-sm pour limiter la largeur du formulaire
      // 2. Ajout de mx-auto pour centrer le formulaire s'il est plus petit que son parent
      // 3. Ajout de w-full pour qu'il prenne la largeur maximale autorisée par max-w-sm
