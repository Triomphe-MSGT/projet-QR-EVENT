...
import { useUpgradeToOrganizer } from "../../hooks/useUserProfile"; // Assurez-vous que le chemin est correct
...
const UpgradeToOrganizerModal = ({ onClose }) => {
  ...
  // --- 1. AJOUTER L'ÉTAT POUR LE TÉLÉPHONE ---
  ...
  const handleSubmit = (e) => {
    ...
    // --- 3. ENVOYER LE TÉLÉPHONE AU BACKEND ---
    upgradeMutation.mutate(
      { sexe, profession, phone }, // <- Ajouté ici
      {
        onSuccess: () => {
    ...
    >
      ...
      >
        ...
        <p className="text-gray-600 dark:text-gray-400 mb-6">
          Pour créer vos propres événements, veuillez compléter votre profil.
